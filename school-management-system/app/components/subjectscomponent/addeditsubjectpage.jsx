...
const AddEditSubjectPage = ({
  ...
  const title = id ? `Edit ${formData?.subject_name} Details` : "Add New subject";
        ...
        <section className="text-cyan-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
            <InputField
              ...
              placeholder="e.g. Mathematics, English Language etc"
            />
          </div>
        </section>
      </div>
...
export default AddEditSubjectPage;
